...
class IterationThreeGradeImport implements ToModel
{
    /**
    * @param array $row
    *
    ...
    */
    ...
    {
        return new IterationThreeGrade([
            'name' => $row[0],
            'npm' => $row[1],
            'agama' => $row[2],
            'pancasila' => $row[3],
            ...
            'metode_penelitian' => $row[44],
            'arsitektur_si_ti' => $row[45],
            'proyek_aplikasi_si' => $row[46],
            'prak_proyek_aplikasi_si' => $row[47],
            'kuliah_kerja_nyata' => $row[48],
            'enterprise_resource_planning' => $row[49],
            'machine_learning' => $row[50],
            'sistem_pendukung_keputusan' => $row[51],
            'digital_marketing' => $row[52],
            'sistem_informasi_pemerintahan' => $row[53],
