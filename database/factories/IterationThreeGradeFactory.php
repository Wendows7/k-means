...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\IterationThreeGrade>
 */
class IterationThreeGradeFactory extends Factory
{
    /**
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'metode_penelitian' => $this->faker->randomElement($gradeScale),
            'arsitektur_si_ti' => $this->faker->randomElement($gradeScale),
            'proyek_aplikasi_si' => $this->faker->randomElement($gradeScale),
            'prak_proyek_aplikasi_si' => $this->faker->randomElement($gradeScale),
            'kuliah_kerja_nyata' => $this->faker->randomElement($gradeScale),
            'enterprise_resource_planning' => $this->faker->randomElement($gradeScale),
            'machine_learning' => $this->faker->randomElement($gradeScale),
            'sistem_pendukung_keputusan' => $this->faker->randomElement($gradeScale),
            'digital_marketing' => $this->faker->randomElement($gradeScale),
            'sistem_informasi_pemerintahan' => $this->faker->randomElement($gradeScale),
