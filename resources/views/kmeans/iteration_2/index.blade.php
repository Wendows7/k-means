...
@section('content_body')
    <div class="container">
        <h1 class="text-center">K-Means Clustering - Iteration 2</h1>
        <p class="text-center">This is the second iteration of the K-Means clustering algorithm.</p>
        <form action="{{route('kmeans.data.import')}}" method="POST" class="d-inline" id="import" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="iteration" value="2">
