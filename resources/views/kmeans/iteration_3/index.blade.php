...
@php
    $heads = [
            ...
            'metode_penelitian',
            'arsitektur_si_ti_(sistem_informasi_teknologi_informasi)',
            'proyek_aplikasi_si',
            'prak_proyek_aplikasi_si',
            'kuliah_kerja_nyata_(kkn)',
...
@section('content_body')
    <div class="container">
        <h1 class="text-center">K-Means Clustering - Iteration 3</h1>
        ...
        <form action="{{route('kmeans.data.import')}}" method="POST" class="d-inline" id="import" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="iteration" value="3">
        ...
        @if(session('result'))
            @foreach($data as $value)
                <tr>
                    ...
                    <td>{{$value->rekayasa_perangkat_lunak}}</td>
                    <td>{{$value->teknologi_open_source}}</td>
                    <td>{{$value->prak_teknologi_open_source}}</td>
                    <td>{{$value->manajemen_proyek_si}}</td>
                    <td>{{$value->fundamental_data_sains}}</td>
                    <td>{{$value->e_bisnis}}</td>
                    <td>{{$value->data_mining}}</td>
                    <td>{{$value->sistem_informasi_perusahaan}}</td>
                    <td>{{$value->e_commerce}}</td>
                    <td>{{$value->business_proses_reenginering}}</td>
                    <td>{{$value->metode_penelitian}}</td>
                    <td>{{$value->arsitektur_si_ti}}</td>
                    <td>{{$value->proyek_aplikasi_si}}</td>
                    <td>{{$value->prak_proyek_aplikasi_si}}</td>
                    <td>{{$value->kuliah_kerja_nyata}}</td>
                    <td>{{$value->enterprise_resource_planning}}</td>
                    <td>{{$value->machine_learning}}</td>
                    <td>{{$value->sistem_pendukung_keputusan}}</td>
                    <td>{{$value->digital_marketing}}</td>
                    <td>{{$value->sistem_informasi_pemerintahan}}</td>
                    <td>{{$value->C1}}</td>
                    <td>{{$value->C2}}</td>
                    <td>{{$value->C3}}</td>
                    <td>{{$value->C4}}</td>
